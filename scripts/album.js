...
var createSongRow = function(songNumber, songName, songLength) {
  ...
  var clickHandler = function() {
    ...
    if (currentlyPlayingSongNumber !== songNumber) {
        ...
        $(this).html(pauseButtonTemplate);//play currentSoundFile
        currentSongFromAlbum = currentAlbum.songs[songNumber - 1];
        updatePlayerBarSong();
    ...
    // Switch from Play -> Pause button to indicate new song is playing.
        ...
        if (currentSoundFile.isPaused()) {// Switch from Pause -> Play button to pause currently playing song.
...
var setupSeekBars = function() {
  ...
  //if class of seek bar's parent is changing volume or seeking song
